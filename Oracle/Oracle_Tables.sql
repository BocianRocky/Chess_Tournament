...
CREATE TABLE Arbitrzy (
    ...
    kraj varchar2(25)  NOT NULL,
    doświadczenie varchar2(30)  NOT NULL,
...
CREATE TABLE Wyniki (
    ...
    białe_wynik number(3,2)  NOT NULL,
    czarne_wynik number(3,2)  NOT NULL,
...
CREATE TABLE Zawodnicy (
    ...
    Klub_szachowy_Nazwa_klubu varchar2(30)  NOT NULL,
