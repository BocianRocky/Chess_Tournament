...
drop table if exists Kategorie_szachowe;
drop table if exists Wyniki;
drop table if exists Partia;
drop table if exists stoly;
drop table if exists Runda;
drop table if exists Zawodnicy;
drop table if exists Klub_szachowy;
drop table if exists Arbitrzy;
...
INSERT INTO Klub_szachowy (id_klubu,Nazwa_klubu, Miasto, Adres)
VALUES (2,'Iskra Szyd owo', 'Sulejowek', ' owcza 23');
